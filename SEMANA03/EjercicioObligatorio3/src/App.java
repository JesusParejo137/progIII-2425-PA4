...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        for (int i = 0; i < personas.length; i++) {
            ...
            String promptTalla = String.format("Ingrese la talla de %s: \n", personas[i].getNombre());
        ...
        String personaIMC = Esdia.readString("Escriba el nombre de la persona de la que quiere calcular su IMC: ");
        for (Persona persona : personas) {
            if (persona.getNombre().equals(personaIMC)) {
                System.out.printf("El IMC de %s es %f.", persona.getNombre(), persona.calcularIMC());
                break;
            }
        }
        //Esdia ya está preparado para manejar adecuadamente si el usuario trata de introducir un valor que no corresponda con el establecido
    }
}