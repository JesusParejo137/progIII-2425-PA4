...
public class Persona {
    ...
    public static Persona getPersonFromDelimitedString(String delimitedString, String delimiter){
        ...
        if(chunks.length != 3){
            // Esto próximamente será una excepción
            // Tomamos línea como inválida
            return null;
        }
    ...
    public String getAsColumnString(){
        ...
        String formatString = "%"+columnSizes[0]+"s"+"%"+columnSizes[1]+"d"+"%"+columnSizes[2]+".2f"; // Establecemos el formato de la String
